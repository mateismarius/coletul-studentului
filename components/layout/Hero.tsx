...
export default function Hero() {
    return (
        <section
            className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-neutral-50 to-white overflow-hidden relative">
            ...
            <div className="max-w-7xl mx-auto relative">
                <div className="text-center mb-16">
                    ...
                    <SlideUp delay={0.6}>
                        <p className="text-lg text-neutral-500 mb-12 max-w-3xl mx-auto">
                            Pachete, mancare de acasa, medicamente si tot ce au nevoie copiii tai la facultate.
                            Livrare la camin sau adresa preferata.
                        </p>
                    </SlideUp>
                ...
                <StaggerContainer className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 mb-16">
                    <StaggerItem>
                        <HoverLift
                            className="bg-white/80 backdrop-blur-sm border border-neutral-200 rounded-2xl p-6 text-center">
                ...
                <FadeIn delay={1.2}>
                    <div className="bg-white/50 backdrop-blur-sm border border-neutral-200 rounded-3xl p-8 text-center">
                        ...
                        <div className="flex flex-wrap justify-center items-center gap-4 text-neutral-600">
                            <span
                                className="bg-orange-50 border border-orange-200 text-orange-700 px-4 py-2 rounded-xl font-medium">Vaslui → Iasi</span>
                            <span className="text-neutral-400">•</span>
                            <span
                                className="bg-orange-50 border border-orange-200 text-orange-700 px-4 py-2 rounded-xl font-medium">Buzau → Bucuresti</span>
                            <span className="text-neutral-400">•</span>
                            <span
                                className="bg-orange-50 border border-orange-200 text-orange-700 px-4 py-2 rounded-xl font-medium">Bacau → Brasov</span>
                            <span className="text-neutral-400">•</span>
                            <span
                                className="bg-orange-50 border border-orange-200 text-orange-700 px-4 py-2 rounded-xl font-medium">Vrancea → toate orasele</span>
                        </div>
                    </div>
                </FadeIn>
            </div>
