...
import {Check, Star, Phone, Package, Clock, Users, ArrowRightLeft} from 'lucide-react';
    ...
    const routePrices = [
        {
            route: "Vaslui ↔ Iasi",
            distance: "120km",
            durations: { dus: "45lei", dus_intors: "80lei", abonament: "280lei" },
            time: "2-2.5h",
            popular: true
        },
        {
            route: "Buzau ↔ Bucuresti",
            distance: "100km",
            durations: { dus: "50lei", dus_intors: "90lei", abonament: "320lei" },
            time: "1.5-2h",
            popular: true
        },
        {
            route: "Bacau ↔ Brasov",
            distance: "180km",
            durations: { dus: "60lei", dus_intors: "110lei", abonament: "400lei" },
            time: "3-3.5h",
            popular: false
        },
        {
            route: "Vrancea ↔ Bucuresti",
            distance: "150km",
            durations: { dus: "55lei", dus_intors: "100lei", abonament: "360lei" },
            time: "2-2.5h",
            popular: false
        }
    ];
                ...
                <ScrollReveal>
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-neutral-600 max-w-3xl mx-auto mb-8">
                            Tarife fixe pentru transport persoane si coletarie, fara costuri ascunse.
                        ...
                        <div className="inline-flex items-center space-x-2 bg-orange-100 border border-orange-200 text-orange-700 px-4 py-2 rounded-full text-sm font-medium shadow-sm">
                            ...
                            <span>Prima calatorie cu 50% reducere pentru studenti noi</span>
                        </div>
                    </div>
                </ScrollReveal>
                ...
                <ScrollReveal>
                    <div className="mb-20">
                        ...
                        <div className="bg-white rounded-3xl p-8 border border-neutral-200 shadow-lg">
                            <h4 className="text-2xl font-bold text-neutral-900 text-center mb-8">
                                Preturi pe rute - Transport persoane
                            </h4>
